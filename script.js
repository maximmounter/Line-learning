...
const SHOWS = {
  "the empress of ireland": {
    ...
    lines: [
      ...
      { scene: "Scene 6 – Lower Promenade Deck C", char: "Peyton", text: "Stop making excuses! You know what must be done." },
      { scene: "Scene 6 – Lower Promenade Deck C", char: "Crall", text: "I'm not making excuses!" },
